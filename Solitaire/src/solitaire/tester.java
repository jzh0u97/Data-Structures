...
public class tester {
	...
	int getKey() {
		...
		while(true){
			...
			jokerA();// System.out.println("After jokerA: "); printList(deckRear);
			jokerB();// System.out.println("After jokerB: "); printList(deckRear);
			tripleCut();// System.out.println("After triple cut: "); printList(deckRear);
			countCut();// System.out.println("After count cut: "); printList(deckRear); System.out.println();
